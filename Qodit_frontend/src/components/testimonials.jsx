          ...
          >
            ...
            <div className="row testimonialsCenter">
              ...
              <p>
                ...
                regarding the development of our web application. Qodit and the
            ...
            <div className="row testimonialsCenter">
              ...
              <p>
                Qodit.io captured our needs from the start and helped us create
                the webstore we had in mind. Always very quick to respond and
                make adjustments where and when we needed it. 
              </p>
            </div>
          </Carousel>
        </div>
